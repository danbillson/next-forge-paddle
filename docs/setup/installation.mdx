---
title: Installation
description: How to setup, install and run next-forge-paddle.
---

## Initialization

Run the `next-forge-paddle` init command:

```sh Terminal
npx next-forge-paddle@latest init
```
...
┌  Let's start a next-forge-paddle project!
│
