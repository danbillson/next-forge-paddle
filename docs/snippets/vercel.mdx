export const VercelButton = () => {
  ...
  url.searchParams.set('demo-title', 'next-forge-paddle');
  ...
  url.searchParams.set('project-name', 'next-forge-paddle');
  url.searchParams.set('repository-name', 'next-forge-paddle');
  url.searchParams.set('repository-url', 'https://github.com/danbillson/next-forge-paddle');
