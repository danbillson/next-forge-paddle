...
description: Let's use next-forge-paddle to create a simple AI chatbot.
---

Today we're going to create an AI chatbot using next-forge-paddle and the built-in AI package, powered by [Vercel AI SDK](https://sdk.vercel.ai/).
...
```bash Terminal
npx next-forge-paddle@latest init ai-chatbot
```
...
That's it! You've now created an AI chatbot using next-forge-paddle and the built-in AI package. If you have any questions, please reach out to me on [Twitter](https://x.com/danbillson_) or open an issue on [GitHub](https://github.com/danbillson/next-forge-paddle).
