---
title: Web
description: How the website application works in next-forge-paddle.
---
...
next-forge-paddle comes with a default website application, which is located in the `apps/web` folder.
