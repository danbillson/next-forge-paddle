...
While next-forge-paddle does not come with BI tooling out of the box, you can easily add business intelligence and analytics to your app with [Metabase](https://www.metabase.com/).
...
By default, next-forge-paddle uses Neon as its database provider. Metabase works great with Postgres databases so if you're ready to connect, here's what you'll need:
