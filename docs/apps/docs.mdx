---
title: Documentation
description: How the documentation is configured in next-forge-paddle.
---
...
next-forge-paddle uses [Mintlify](https://mintlify.com) to generate beautiful docs. Each page is a `.mdx` file, written in Markdown, with built-in UI components and API playground.
