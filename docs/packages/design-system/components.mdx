---
title: Components
description: next-forge-paddle offers a default component library by shadcn/ui
---

next-forge-paddle contains a design system out of the box powered by [shadcn/ui](https://ui.shadcn.com/).
